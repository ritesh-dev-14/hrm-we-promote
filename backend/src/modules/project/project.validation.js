...
exports.createProjectSchema = Joi.object({
  ...
  reference: Joi.array().items(Joi.string()).allow(null),
  taste: Joi.array().items(Joi.string()).allow(null),
  instaUsername: Joi.string().allow(null, ""),
  facebookUsername: Joi.string().allow(null, ""),
